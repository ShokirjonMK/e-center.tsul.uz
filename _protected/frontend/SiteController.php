...
//------------------------------------------------------------------------------------------------//
 ...
 public function actionGalery($id)
    {
        $id=$id;
          $galery = \common\models\Galery::find()->orderBy(['id' => SORT_DESC])->all();
       $category = \common\models\Category::find()->orderBy(['status' => SORT_DESC])->all();
...
public function actionAllnews()
    {
        $id=$id;
$query = \common\models\News::find()->where(['status' => 1])->orderBy(['date' => SORT_DESC]);
$count = $query->count();
...
public function actionNews($id)
    {
        ...
        $id=$id;
        $news = \common\models\News::find()->orderBy(['id' => SORT_DESC])->where(['id'=>$id])->all();



        $news1 = \common\models\News::find()->orderBy(['id' => SORT_DESC])->limit(4)->all();
          $galery = \common\models\Galery::find()->orderBy(['id' => SORT_DESC])->all();
        $category = \common\models\Category::find()->orderBy(['id' => SORT_DESC])->all();
...
public function actionVazirlik($id)
    {
       
      $vazirlik = \common\models\Vazirlik::find()->where(['status'=>$id])->all();
      
        $text =  \common\models\Vazirlik::text;
    
         return $this->render('vazirlik',[
     ...
     public function actionFilial($id)
    {
$regions = \common\models\Regions::find()->where(['parent_id'=>''])->all();
$regions2 = \common\models\Regions::find()->all();
