                        ...
                        <table id="example" class="table table-striped table-bordered" >
                            ...
                            <?php $i =1;  foreach ($users as $usr): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?=\yii\helpers\Url::to(['../admin/viewuser?id='.$usr->id])?>"><span class="glyphicon glyphicon-eye-open"></span></a>
                                        <a href="<?=\yii\helpers\Url::to(['../admin/update?id='.$usr->id])?>"><span class="glyphicon glyphicon-pencil"></span></a>
