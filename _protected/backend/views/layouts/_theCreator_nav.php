              ...
              <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <span class="dropdown-item dropdown-header"> </span>
                            ...
                            <div class="dropdown-divider"></div>
                            <a href="<?=\Yii\helpers\Url::to(["/sms/view/?id=$sms->id"], true)?>" class="dropdown-item">
                            <i class="fas fa-envelope mr-2"></i> <?=substr ($sms->title, 0, 10).'...';?>
                            <span class="float-right text-muted text-sm"><?= date('Y-m-d h:m', ($sms->date))?></span>
                        </a>
                      
                        <div class="dropdown-divider"></div>
                        <a href="<?=\Yii\helpers\Url::to(["/sms/index"], true)?>"
                            class="dropdown-item dropdown-footer">Barchasini ko`rish</a>
                        </div>
                </li>
