                ...
                <div class="row">
                    <div class="col-lg-6">
                        <?php if ($user->scenario === 'create') {
                            $create_username = \common\models\User::find()->orderBy(['id' => SORT_DESC])->one();
                            $ID = $create_username->id + 1 + 10000;
                            $username = "S" . $ID;
                        }
                        ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <?= $form->field($user, 'yunalish')->dropDownList(
                                    $dir,
                                    [
                                        'options' => [$direction->id => ['selected' => true]], 'class' => 'browser-default head custom-select',  'prompt' => 'Yunalishlar',
                                        'onchange' => '
                            ...
                            <div class="col-sm-4">
                                ...
                                <?= $form->field($user, 'group_id')->dropDownList($group1, ['options' => [$faculty->id => ['selected' => true]]]) ?>
                            </div>
                        </div>
